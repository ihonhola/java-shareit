...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(Integer itemId, ItemDto itemDto, Integer userId) {
    ...
    public ResponseEntity<Object> addComment(Integer itemId, CommentRequestDto commentDto, Integer userId) {
